...
export default function MyJobListings() {
  ...
  return (
    <>
      ...
      <JobListing open={open} setOpen={setOpen} open2={open2} setOpen2={setOpen2}/>
...
const JobListing = (props: {
  ...
  return (
      <div onClick={() => {
          props.setOpen(true);
          props.setOpen2(false);}} className="hover:cursor-pointer">
          ...
          <div className="p-6">
            <div className="overflow-hidden truncate">
              <div className="flex items-center gap-4">
                <Avatar size={8} logoURL={"https://cdn-icons-png.flaticon.com/512/174/174857.png"} />
